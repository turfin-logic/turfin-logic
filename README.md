...
|---|---|
| **Core Languages** | Python, TypeScript, Go, JavaScript, PowerShell |
| **Frontend** | React, Next.js, HTML5/CSS3 (Tailwind) |
| **Backend & APIs** | FastAPI, Node.js, GraphQL, REST |
| **AI & LLMs** | OpenAI, Google Gemini, Model Context Protocol (MCP), HuggingFace |
| **DevOps & Cloud** | Docker, GitHub Actions, Linux/Bash, AWS, GCP |
